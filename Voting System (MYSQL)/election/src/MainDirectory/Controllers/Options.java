...
public class Options {
    ...
    public void checkLoginAdmin() throws SQLException {
        ...
        if (username.isEmpty() || password.isEmpty()) {
            ...
            // Connector.validateAdmin() returns a boolean variable
            if (Connector.validateAdmin(username, password)) {
    ...
    private void checkVoterLogin() {
        try {
            ...
            if (voterIds.contains(voter_id)) {
                ...
                // Connector.validateVoter() returns a boolean variable
                if (Connector.validateVoter(voter_id)) {
    ...
    @FXML
    void startVoting() throws IOException, SQLException {
        // Connector.dataExits() returns a boolean variable
        if (Connector.dataExists()) {
