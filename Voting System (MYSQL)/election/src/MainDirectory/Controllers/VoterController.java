...
public class VoterController {
    ...
    public void refreshTable() {
        try {
            ...
            ResultSet set = Connector.newSqlQuery("SELECT * FROM `voter`");

            while (set.next()) {
                voters.add(new Voters(set.getInt("voter_id"), set.getString("first_name"),
                        set.getString("last_name"), set.getString("address"),
                        set.getString("gender"), set.getString("dob")));
            }
    ...
    private void deleteVoter() {
        try {
            ...
            Connector.deleteVoter(voters.getVoter_id());
